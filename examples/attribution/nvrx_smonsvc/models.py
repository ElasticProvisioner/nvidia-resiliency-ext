...
class MonitorState:
    ...
    # Job counters
    total_jobs_seen: int = 0  # Total unique jobs ever seen
    total_with_output_path: int = 0  # Total jobs that had output path
    total_logs_submitted: int = 0  # Total POST attempts (success or client error)
    total_post_success: int = 0  # Total successful POSTs
    total_results_fetched: int = 0  # Total successful GETs
