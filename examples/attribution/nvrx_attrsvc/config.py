...
class Settings(BaseSettings):
    ...
    # Slack integration (optional - set SLACK_BOT_TOKEN to enable)
    SLACK_BOT_TOKEN: str = Field(default="", description="Slack bot token (empty = disabled)")
    SLACK_CHANNEL: str = Field(default="", description="Slack channel for alerts")
