...
NVRX_ATTRSVC_ALLOWED_ROOT=/path/to/logs \
  sbatch --account=myaccount examples/attribution/scripts/nvrx_services.sbatch
```
...
```bash
./examples/attribution/scripts/build_enroot_image.sh
```
...
./nvrx_smonsvc/snapshot_smonsvc.sh hostname 8100
```
